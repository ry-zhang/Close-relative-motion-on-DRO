...
function ydot = eom_rel3b_NoLiner(t,y,mu)
...
r_REL_dot = v_REL;
Arho =(1- mu)*r_E_LVLH/r_E_C3-(1- mu)*(r_E_LVLH+r_REL)/(norm(r_E_LVLH+r_REL))^3+mu*r_LVLH/(norm(r_LVLH))^3-mu*(r_LVLH+r_REL)/(norm(r_LVLH+r_REL))^3;
v_REL_dot = -2*Omega_li*v_REL -(Omega_li_dot +  Omega_li^2)*r_REL+Arho;
