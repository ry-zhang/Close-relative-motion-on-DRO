...
% v2(2020-06-20): 将LVLH坐标系由k-r,j-h,i-cross(j,k)修改为i-r,k-h,j-cross(k,r)

function ydot = eom_rel3b(t,y,mu)
...
v_REL_dot = -2*Omega_li*v_REL ...
     - (Omega_li_dot +  Omega_li^2 ...
     + mu/r_M_C3*(I-3*r_LVLH*r_LVLH'/r_M_C_norm^2) ...
     + (1-mu)/r_E_C3*(I-3*r_E_LVLH*r_E_LVLH'/r_E_C_norm^2))*r_REL;
