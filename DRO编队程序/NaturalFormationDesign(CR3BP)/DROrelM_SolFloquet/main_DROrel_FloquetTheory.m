...
save ../../subF_eom(CR3BP)/FloquetEig12_sy Meigve Meigva_diag EigenVector Sol_linear state_ini_all J_period_all x0_DRO_M_3d para con
...
%         rel_motion_VVLH_linear = T_TCR2TCO_CR3BP(rel_motion_M_linear',abs_motion_M','VVLH',con.mu)';
    ...
    %       legend('InitialPos','FinalPos')
        ...
        title(['\bf x_{\rm',num2str(jj_index),'}\rm(t)']); set(gca,'FontSize',13)
        grid on; grid minor
