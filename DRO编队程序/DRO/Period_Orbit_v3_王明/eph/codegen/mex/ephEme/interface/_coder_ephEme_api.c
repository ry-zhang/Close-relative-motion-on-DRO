 ...
 * _coder_ephEme_api.c
 *
 * Code generation for function '_coder_ephEme_api'
 *
 */
  ...
  const emlrtMsgIdentifier *msgId))[233580]
{
  ...
  void ephEme_api(const mxArray * const prhs[4], const mxArray *plhs[1])
{
  real_T (*rv)[6];
  real_T jd;
  real_T ntarg;
  ...
  ephEme(&st, jd, ntarg, ncent, *C_Mat, *rv);

  /* Marshall function outputs */
  plhs[0] = emlrt_marshallOut(*rv);
}

/* End of code generation (_coder_ephEme_api.c) */
