START_DIR = D:\360安全云盘同步版\[Code]\jplEph

MATLAB_ROOT = C:\PROGRA~1\MATLAB\R2016a
MAKEFILE = ephEme_mex.mk

include ephEme_mex.mki
...
SRC_FILES =  \
	...
	error.c \
	cheb_Interp.c \
	_coder_ephEme_info.c \
	_coder_ephEme_api.c \
	_coder_ephEme_mex.c \
	ephEme_emxutil.c

MEX_FILE_NAME_WO_EXT = ephEme_mex
...
SYS_INCLUDE += -I"$(START_DIR)\codegen\mex\ephEme"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\ephEme/%.c
	$(CC) -Fo"$@" $(CFLAGS) "$<"
