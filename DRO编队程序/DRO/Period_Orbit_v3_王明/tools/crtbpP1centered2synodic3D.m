function [xx , tt] = crtbpP1centered2synodic3D(XX , TT , mu)
% Coordinate change from inertial, P1-centerd to synodic frame
%
% [xx, tt] = P1centered2synodic3D (XX, TT, mu)
%
% Input arguments:
% -------------------------------------------------------------------------
% XX        [nx6]    state vector in P1-centerd frame    [adim.]
