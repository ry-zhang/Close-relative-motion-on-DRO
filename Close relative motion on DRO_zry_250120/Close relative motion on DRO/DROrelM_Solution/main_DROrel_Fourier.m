...
sol1_sample_fit = deval(sol1,t_sample_fit);%相对运动积分解
...
% 相对误差plot3(e3_refit(:,1),e1_refit(:,2),e1_refit(:,3),'b');
...
figure()
plot3(e1_refit(:,1),e3_refit(:,2),e3_refit(:,3),'b');
