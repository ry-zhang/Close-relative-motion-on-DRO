...
function ydot= eom_rel3b_alpha(t,y,mu)
...
% r_E_C = r_C-(3.84399*10^5*[-1;0;0]);r_E_C_norm  = norm(r_E_C); r_E_C3 = r_E_C_norm^3;
...
Arho2=-(mu/r_LVLH3*(I-3*r_LVLH*r_LVLH'/r_LVLH2) ...
     + (1-mu)/r_E_LVLH3*(I-3*r_E_LVLH*r_E_LVLH'/r_E_LVLH2));%*4.0351e+05;
Arho=Arho1+Arho2;
